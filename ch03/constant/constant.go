...
func untypedConstant2() {
	var x float32 = math.Pi // math.pi is an untyped constant can be assigned to a float 32 number but lost of precision happens
	var y float64 = math.Pi // float 64 keeps more digits after decimal point
	var z complex128 = math.Pi
	fmt.Println(x, y, z)

	fmt.Println(math.MinInt, math.MaxInt)

	// Ok, how about that??? this section completely fails due to overflow
